...
export const events: CosmosEvent[] = [
  {
    ...
    coverImage: "/images/cosmos-dialogue/nordic-business-forum-cover.jpg",
    gallery: [
      "/images/cosmos-dialogue/nordic-business-forum-1.jpg",
      "/images/cosmos-dialogue/nordic-business-forum-2.jpg",
      "/images/cosmos-dialogue/nordic-business-forum-3.jpg",
      "/images/cosmos-dialogue/nordic-business-forum-4.jpg",
    ],
  },
  {
    id: "50-years-of-bangladesh-china-relations",
    title: "50 Years of Bangladesh-China Relations: Achievements, Challenges and Prospects",
    date: "June 19, 2026",
    category: "Cosmos Dialogue",
    excerpt: "Scholars from both countries at a book launching-cum-seminar have said the next fifty years promise even greater opportunities for both nations.",
    description: [
      ...
      "The event marking the formal launching of a book titled 50 Years of Bangladesh-China Relations: Achievements, Challenges and Prospects was held in city’s Baridhara on Friday evening as part of the Cosmos Dialogue hosted by Cosmos Foundation, the philanthropic arm of the Cosmos Group.",
      "The seminar was chaired by renowned scholar and Cosmos Foundation president Iftekhar Ahmed Chowdhury while Catherine Grace Gardner Khan made the formal announcement of the event with her brief remarks.",
      ...
      "Highlighting the all-weather friendship and strategic partnership that exists between Bangladesh and China, Iftekhar said these are likely to be strengthened during the upcoming visit of prime minister Tarique Rahman.",
      "He said Chinese investments are most certain to be welcome and that Bangladesh will need to ensure that non-tariff barriers are addressed and administrative procedures are eased. Bangladeshpolitics analysis",
      "Iftekhar highlighted that projects should entail skill transfer, good governance, efficient management, timely completion, and compliance with environmental sustainability.",
      ...
      "He said that as Bangladesh pursues its own developmental goals, the relationship with China is likely to remain pivotal in shaping the region’s and the world’s geopolitical landscape.",
      ...
      "They emphasised that the friendship was built on mutual trust, respect, and a shared commitment to development.",
      ...
      "The contributors to the book are — Enayetullah Khan, Professor Imtiaz Ahmed, Yang Hui, Professor Amena Mohsin, Chen Songtao, Syed Shahnawaz Mohsin, Mahmud Hussain, Wang Zhen and Jin Qi’dong; Cui Rongwei, MM Akash, Cheng Min, Guo Na and Fu Hongai; FM Arafat and Humayun Kabir, Li Hongmei, and Iftekhar Ahmed Chowdhury.",
      "Speaking at the seminar, Professor Imtiaz hoped that the book will attract the attention of academics, policymakers, and researchers — both in Bangladesh and China and across the wider world. Bangladeshpolitics analysis",
      ...
      "‘So, I will request all of you to read the book. The book highlights the past, present, and future,’ Professor Imtiaz said.",
      "Wang Zhen, Professor of International Studies at the Shanghai Academy of Social Sciences, said the two countries had enjoyed very good relations over the past 50 years and have enough confidence to move forward for another 50 years. He said the two countries can build international relations in a rational and pragmatic manner.",
      ...
      "‘Perhaps we can learn from history. We can do more in the future because we have lessons from history,’ said Professor Zhen, noting that China has many new plans for the future.",
      ...
      "It is within this evolving global landscape that Bangladesh must carefully position itself, he said, noting that Bangladesh is not merely a modern state; it is the inheritor of a rich civilisational legacy.",
      ...
      "Professor Amena Mohsin said this volume is not merely a reflection on the past and present of Bangladesh-China relations; it is a forward-looking work that offers valuable policy insights and recommendations for the future.",
    ...
    coverImage: "/images/cosmos-dialogue/bangladesh-china-50-years-cover.jpg",
    gallery: [
      "/images/cosmos-dialogue/bangladesh-china-50-years-1.jpg",
      "/images/cosmos-dialogue/bangladesh-china-50-years-3.jpg",
      "/images/cosmos-dialogue/bangladesh-china-50-years-4.jpg",
      "/images/cosmos-dialogue/bangladesh-china-50-years-5.jpg",
      "/images/cosmos-dialogue/bangladesh-china-50-years-6.jpg",
    ],
  },
  {
    id: "eu-bangladesh-transition-cosmos-dialogue",
    title:
      "EU wants Bangladesh to succeed in its transition from 'autocracy to democracy'",
    date: "February 18, 2025",
    category: "Cosmos Dialogue",
    excerpt:
      "EU wants Bangladesh’s transition from autocracy to democracy, emphasizing reforms, climate cooperation, economic diversification and stronger bilateral ties for a sustainable future.",
    description: [
      ...
      "President of Bay of Bengal Institute and Honorary Adviser Emeritus, Cosmos Foundation Ambassador (Retd) Tariq A Karim, Dhaka University Prof at Department of Development Studies Rashed Al Mahmud Titumir, Prof at Department of International Relations, University of Dhaka Dr Lailufar Yasmin; Cosmos Group DMD and Honorary Consul of Ireland in Bangladesh Masud Khan and Cosmos Foundation Executive Director Nahar Khan, among others, attended. Members of the diplomatic corps and distinguished academicians were also present.",
      ...
      "Ambassador Tariq Karim said: “We are today in a state of transition, even Europe today is in a state of transition. The world today is in a state of transition.” He said none of them is very sure where this transition is going to lead to. “You are perhaps in the process of redefining yourself from what you were 80 years ago and that is an unsettling thought, because that will have ramifications nearer to us and even perhaps in our own homes. And I think the path that you have shown is the path we should be considering.”",
      "On climate resilience and green industrialisation, Prof Titumir said with climate change posing an existential threat, Bangladesh and the EU must deepen cooperation on climate adaptation and mitigation. He said the EU must enhance long-term climate financing commitments for Bangladesh under the Just Energy Transition framework.",
      "Prof Titumir said the Bangladesh-EU relationship stands at a crucial juncture and by working together, Bangladesh and the EU can shape a future that is economically robust, socially just, environmentally sustainable and geopolitically resilient. “Let us seize this moment to craft a new era of partnership—one that serves our people, our economies, and our shared vision for a better world,” he said.",
      "Prof Lailufar Yasmin said Bangladesh’s relationship with the EU is a solid partnership that they can trust and forge ahead on the basis of a lot of issues and commonalities. She highlighted several areas — politics, economy, social development and environment — and laid emphasis on cooperation in developing the capacity of Bangladesh.",
      "The foreign affairs expert flagged the Rohingya issue, noting that Bangladesh is going to face challenges of funding in the coming years and how the European Union can create Bangladesh's capacity to provide opportunities for the Rohingyas. “We can counter disinformation and misinformation against Bangladesh’s transition to a more inclusive journey,” Prof Lailufar said.",
      ...
      "He explained five things, elaborating the EU's role here, why they are here, their political ambition and why they are supporting the reform ambitions of the interim government. “So first, I want to tell you that the EU-Bangladesh partnership is a strategic choice. This is a partnership which is a strategic choice with respect for rights and the creation of economic opportunity at its core,” Ambassador Miller said, adding that the EU is ready to help, in fact, already helping Bangladesh deliver reforms in line with the expectations of Bangladesh’s citizens and private sector.",
      "He said that they do not have a hidden agenda but their agenda is to ensure that this transition is successful. The third message is that their common goal with Bangladesh is to build prosperity and to act together to promote sustainable growth with investment and combat climate change. “This is a very cooperative agenda, but I will not hide from you that we have very clear expectations as well - a level playing field for our business in this country,” he said.",
      ...
      "On foreign direct investment, he said they have an investment stock here of €2 billion. “This is FDI. Frankly, I want to increase that FDI tenfold so that it matches the commercial relationship. It’s my ambition but it’s maybe difficult.” He highlighted the importance of diversification and ways of boosting trade and investment as there is already an excellent foundation on which to build. “It is now important to explore how we can ensure that your economic base is diversified.”",
      "On renewable energy, Ambassador Miller said that Bangladesh needs more ambition. “Without the political ambition, you will not succeed in your green energy transition. We actually want to prioritise an engagement with Bangladesh.”",
    ],
    coverImage: "/images/cosmos-dialogue/eu-bangladesh-transition-cover.jpg",
    gallery: [],
  },
  {
    ...
    coverImage: "/images/cosmos-dialogue/nepal-bangladesh-energy-cover.webp",
    gallery: [
