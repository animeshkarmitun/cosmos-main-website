...
export default function ResourcesSection({ id = "resources" }: ResourcesSectionProps) {
  const ref = useRef<HTMLDivElement>(null);
  const inView = useInView(ref, { once: true, margin: "-80px" });

  return (
    <section id={id} className="relative bg-[#07122B] overflow-hidden">
      {/* Top divider */}
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-red-950/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-cyan-950/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-24 md:py-32">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold font-display text-white tracking-tight uppercase leading-tight mb-5">
            Download Brochures
          </h2>
            ...
            >
              <div className="flex items-start gap-5 mb-6">
                ...
                <div className="min-w-0">
                  <h3 className="text-lg md:text-xl font-bold text-white tracking-tight leading-tight mb-1">
                    {brochure.title}
                  </h3>
