...
export default function BusinessUnitsLight({ onNavigate }: BusinessUnitsLightProps) {
  const companies = [
    ...
    { name: "Cosmos Marketing", subtitle: "Comprehensive consultation and marketing strategies.", icon: TrendingUp, page: "marketing", image: "/images/cosmos-marketing-card.png" },
    { name: "Cosmos Shipping & Logistics", subtitle: "Global logistics and freight management with unparalleled efficiency.", icon: Ship, page: "shipping", image: "/images/shipping.jpg" },
